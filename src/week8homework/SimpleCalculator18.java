...
public class SimpleCalculator18 {
    ...
    public static void main(String[] args) {
        ...
        SimpleCalculator18 calculator18 = new SimpleCalculator18();
        calculator18.setFirstNumber(5.0);
        calculator18.setSecondNumber(4);
        System.out.println("add = " + calculator18.getAdditionResult());
        System.out.println("subtract = " + calculator18.getSubtractionResult());
        calculator18.setFirstNumber(5.25);
        calculator18.setSecondNumber(0);
        System.out.println("multiply = " + calculator18.getMultiplicationResult());
        System.out.println("divide = " + calculator18.getDivisionResult());
