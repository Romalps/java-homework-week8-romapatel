...
public class FirstAndLastDigitSum7 {
    ...
    public static int sumFirstAndLastDigit(int number) {
        ...
        if (number < 0) {
            System.out.println("number is negative and needs to be positive.");
            return -1;
        ...
        System.out.println("The first digit is " + firstDigit + " and" + " last digit is " + lastDigit + " and sum of the digit is " + sum);
        return sum;
    }
